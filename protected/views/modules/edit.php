<div class="page">
	<div class="pageContent">
		<form method="post" action="<?php echo CHtml::normalizeUrl(array('modules/edit'));?>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
			<div class="pageFormContent" layoutH="58">
				...
				<div class="unit">
					...
					<input type="text" size="50" name="data[requirements]" value="<?php echo $data->module_name;?>"/>
				</div>
				<div class="divider"></div>
				
				<div class="unit">
					<label>文件路径名：</label>
					<input type="text" size="50" name="data[link]" value="<?php echo $data->link;?>"/>
				</div>
				<div class="divider"></div>
