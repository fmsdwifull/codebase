<div class="page">
	<div class="pageContent">
		<form method="post" action="<?php echo CHtml::normalizeUrl(array('modules/add'));?>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
			<div class="pageFormContent" layoutH="58">
				...
				<div class="unit">
					<label>文件路径名：</label>
					<input type="text" size="50" name="data[link]" />
				</div>
				<div class="divider"></div>
