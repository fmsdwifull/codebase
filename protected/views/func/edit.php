	...
	<div class="pageContent">
		<form method="post" action="<?php echo CHtml::normalizeUrl(array('func/edit'));?>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
			<div class="pageFormContent" layoutH="58">
				...
				<div class="unit">
					<label>函数参数：</label>
					<input type="text" size="50" name="data[Parameter]" class="required" value="<?php echo $data->Parameter;?>"/>
				</div>
				<div class="divider"></div>
				
				<div class="unit">
					<label>函数返回值：</label>
					<input type="text" size="50" name="data[ReturnValue]" class="required" value="<?php echo $data->ReturnValue;?>"/>
				</div>
				<div class="divider"></div>
